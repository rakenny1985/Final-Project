...
|OECD   (Note:“This translation was not created by the OECD and should not be considered an official OECD translation. The OECD shall not be liable for any content or error in this translation.”)|OECD, 2019,GeoBook: ODA by sector - bilateral commitments by donor and recipient, [OECD URL](https://stats.oecd.org) |[GeoBook:ODA](https://stats.oecd.org)|[Metadata](https://stats.oecd.org/OECDStat_Metadata/ShowMetadata.ashx?Dataset=DACSECTOR&ShowOnWeb=true&Lang=en)|
